// src/levels/SensingIntegration.jsx
import React, { Suspense, useCallback, useEffect, useMemo, useState } from "react";

// Import educational slides for this level
import SensorIntegrationBasics from "./slidesSensing/01-SensorIntegrationBasics";
import ExploringTopicsInteractive from "./slidesSensing/01a-ExploringTopicsInteractive";
...
const SLIDES = [
  {
    ...
    Component: SensorIntegrationBasics,
  },
  {
    ...
    Component: ExploringTopicsInteractive,
  },
];

export default function SensingIntegration({ onObjectiveHit, onLevelCompleted }) {
