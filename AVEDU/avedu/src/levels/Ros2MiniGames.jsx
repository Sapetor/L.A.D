// src/levels/Ros2MiniGames.jsx
import React, { Suspense, useCallback, useEffect, useMemo, useState } from "react";

// Import educational slides for this level
import TopicCommandsGame from "./slidesROS2Concepts/08-TopicCommandsGame";
import ConnectTheFlowGame from "./slidesROS2Concepts/09-ConnectTheFlowGame";
...
const SLIDES = [
  ...
  },
  {
    ...
    Component: ConnectTheFlowGame,
  },
];

export default function Ros2MiniGames({ onObjectiveHit, onLevelCompleted }) {
