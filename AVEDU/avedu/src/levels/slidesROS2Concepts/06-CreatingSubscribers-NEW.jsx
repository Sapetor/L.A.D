...
export const meta = {
  ...
  title: "Creating Subscribers (Interactive)",
  order: 6,
  objectiveCode: "ros2-subs-creating",
};

export default function CreatingSubscribers({ onObjectiveHit, goNext }) {
  const { hitObjective } = useProgress();

  // Handle tutorial completion
  const handleTutorialComplete = useCallback(() => {
    console.log(`[Tutorial] Completed: Creating Subscribers`);
  ...
  const handleTutorialSkip = useCallback(() => {
    console.log(`[Tutorial] Skipped: Creating Subscribers`);
  }, []);
  ...
  return (
    <div className="slide-wrap" style={{ width: "100%", maxWidth: "100%", padding: 0 }}>
      <EmbeddedIDE
        ...
        tutorial={ideTutorials.createSubscriber}
