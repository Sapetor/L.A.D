// src/levels/SensingSubscribe.jsx
import React, { Suspense, useCallback, useEffect, useMemo, useState } from "react";

// Import educational slides for this level
import SubscribingToSensorData from "./slidesSensing/02-SubscribingToSensorData";
import LidarSubscriberInteractive from "./slidesSensing/02a-LidarSubscriberInteractive";
import CameraSubscriberInteractive from "./slidesSensing/02b-CameraSubscriberInteractive";
...
const SLIDES = [
  {
    ...
    Component: SubscribingToSensorData,
  },
  {
    ...
    Component: LidarSubscriberInteractive,
  },
  {
    ...
    Component: CameraSubscriberInteractive,
  },
];

export default function SensingSubscribe({ onObjectiveHit, onLevelCompleted }) {
