// src/levels/SensingTasks.jsx
import React, { Suspense, useCallback, useEffect, useMemo, useState } from "react";

// Import educational slides for this level
import SensingTasksGames from "./slidesSensing/04-SensingTasksGames";
...
const SLIDES = [
  {
    ...
    Component: SensingTasksGames,
  },
];

export default function SensingTasks({ onObjectiveHit, onLevelCompleted }) {
